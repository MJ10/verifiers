                            ...
                            if not active_continue_states:
                                ...
                                if proxy_tokenizer is not None:
                                    ...
                                    for messages in continue_chunk_inputs:
                                        print(f"Original final message: '{messages[-1]['content']}'")
                                        prompt = proxy_tokenizer.apply_chat_template(
                                            messages,
                                            tokenize=False,
                                        ...
                                        print(f"Template output: '{prompt}'")
                                        print(f"Template output ends with final message: {prompt.endswith(messages[-1]['content'])}")
                                        print("---")
